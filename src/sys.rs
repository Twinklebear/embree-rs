...
pub const RTC_VERSION_MINOR: u32 = 0;
...
pub const RTCCurveFlags_NEIGHBOR_LEFT: RTCCurveFlags = RTCCurveFlags(1);
pub const RTCCurveFlags_NEIGHBOR_RIGHT: RTCCurveFlags = RTCCurveFlags(2);
...
pub const RTCSceneFlags_NONE: RTCSceneFlags = RTCSceneFlags(0);
pub const RTCSceneFlags_DYNAMIC: RTCSceneFlags = RTCSceneFlags(1);
pub const RTCSceneFlags_COMPACT: RTCSceneFlags = RTCSceneFlags(2);
pub const RTCSceneFlags_ROBUST: RTCSceneFlags = RTCSceneFlags(4);
pub const RTCSceneFlags_CONTEXT_FILTER_FUNCTION: RTCSceneFlags = RTCSceneFlags(8);
...
>;
pub const RTCBuildFlags_NONE: RTCBuildFlags = RTCBuildFlags(0);
pub const RTCBuildFlags_DYNAMIC: RTCBuildFlags = RTCBuildFlags(1);
